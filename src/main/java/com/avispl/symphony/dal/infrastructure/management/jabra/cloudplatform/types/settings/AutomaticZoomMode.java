...
/**
 * Represents the options of automatic zoom modes for the device settings.
 *
 * @author Kevin / Symphony Dev Team
 * @since 1.0.0
 */
public enum AutomaticZoomMode implements BaseSetting {
	...
	AutomaticZoomMode(String name, String value) {
		this.name = name;
		this.value = value;
	}
