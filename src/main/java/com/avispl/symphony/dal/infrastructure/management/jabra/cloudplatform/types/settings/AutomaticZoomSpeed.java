...
/**
 * Represents the options of automatic zoom speed for the device settings.
 *
 * @author Kevin / Symphony Dev Team
 * @since 1.0.0
 */
public enum AutomaticZoomSpeed implements BaseSetting {
	...
	AutomaticZoomSpeed(String name, String value) {
		this.name = name;
		this.value = value;
	}
