...
/**
 * Represents the options of dynamic composition for the device settings.
 *
 * @author Kevin / Symphony Dev Team
 * @since 1.0.0
 */
public enum DynamicComposition implements BaseSetting {
	...
	DynamicComposition(String name, String value) {
		this.name = name;
		this.value = value;
	}
